  ...
  return (
    <div className="app">
      ...
      <div className="header">
        <div>
          <h1>🎰 Loto Rico</h1>
          <p>Inteligência Estatística para Lotofácil</p>
        </div>
      ...
      <div className="main-grid">
        ...
        <div className="card">
          ...
          <div className="form-group">
            <label>Dezenas por jogo: <strong style={{ color: 'var(--accent)' }}>{dezenas}</strong></label>
            <input
              type="range"
              min="15"
              max="20"
          ...
          <div className="form-group">
            <label>Quantidade de jogos: <strong style={{ color: 'var(--accent)' }}>{quantidade}</strong></label>
            <input
              type="range"
              min="1"
              max="300"
          ...
          <div className="form-group">
            <label>Janela de análise: <strong style={{ color: 'var(--accent)' }}>{janela}</strong> concursos</label>
            <input
              type="range"
              min="5"
              max="50"
